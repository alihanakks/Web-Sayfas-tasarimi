        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="package.php" class="nav-item nav-link">Paketler</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Odevler</a>
                    ...
                    <a href="contact.php" class="nav-item nav-link active">Tablo</a>
                </div>
            ...
            <div class="container py-5">
                <div class="row justify-content-center py-5">
                    <div class="col-lg-10 pt-lg-5 mt-lg-5 text-center">
                        <h1 class="display-3 text-white animated slideInDown">Tablo Yap</h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb justify-content-center">
                                <li class="breadcrumb-item"><a href="index.html">Ana Sayfa</a></li>

                                <li class="breadcrumb-item text-white active" aria-current="page">Tablo</li>
                            </ol>
                        </nav>
                    </div>
                </div>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="section-title bg-white text-center text-primary px-3">Dene Gör</h6>
                <h1 class="mb-5"> Tablo Yap</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <form action="contact.php" method="get">

                        <input type="hidden" name="link" value="tabloyap">


                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="satir" class="form-control" id="name"
                                    placeholder="'Satır Boyutu"> <br>
                                <label for="name">Satır Boyutu</label>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-floating">
                                <input type="text" name="sutun" class="form-control" id="name"
                                    placeholder="'Sutun Boyutu"> <br>
                                <label for="name">Sutur Boyutu</label>
                            </div>
                        </div>
                        <div class="col-12">
                            <button class="btn btn-primary w-100 py-3" type="submit" value="Tablo Yap">Tablo
                                YAp</button>
                        </div>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Türkiye</a>,Tüm Hakları saklıdır.
